...
Plugin Name can be installed through several methods. Choose the one that works best for you.

## 📦 Method 1: Community Plugins (Recommended)

Once approved, Plugin Name will be available in the Obsidian Community Plugins directory:
...
4. Enter the repository URL: `yourusername/plugin-name`
5. Click **Add Plugin**
...
1. Download the latest `main.js`, `manifest.json`, and `styles.css` from the [Releases page](https://github.com/yourusername/plugin-name/releases)
2. Navigate to your vault's `.obsidian/plugins/` folder
3. Create a new folder named `plugin-name`
...
1. Open **Settings** → **Community plugins**
2. Confirm **Plugin Name** is listed and enabled
3. You should see a **Plugin Name** settings tab in the main Settings page
4. Try opening the command palette and searching for plugin commands
...
For more help, see the [Troubleshooting Guide](/troubleshooting) or [open an issue on GitHub](https://github.com/yourusername/plugin-name/issues).

---

**Next Step:** Once installed, check out the [Quick Start Guide](/quickstart) to configure and start using the plugin!
